...
static const char *brightnessup[] = { "backlight", "18", NULL };
static const char *brightnessdown[] = { "backlight", "-1", NULL };
static const char *audioup[] = { "pactl", "set-sink-volume", "1", "+10%", NULL };
static const char *audiodown[] = { "pactl", "set-sink-volume", "1", "-10%", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY|ShiftMask,             XK_Home,   spawn,          {.v = brightnessup } },
	{ MODKEY|ShiftMask,             XK_End,    spawn,          {.v = brightnessdown } },
